...
(function() {
	...
	VictorEngine.SFont.setupSFont = function(value, i) {
		...
		while ((match = regex.exec(value)) !== null) {
			...
			//preload
			ImageManager.reserveSFont(name);
	...
	//Nate Edit: preload fonts
	ImageManager.reserveSFont = function(filename, hue, reservationId) {
		return this.reserveBitmap('img/sfonts/', filename, hue, true, reservationId);
	};
	...
	Window_Base.prototype.changeTextColor = function(color) {
		...
		if (this._sfont) {
			//this.contents.sfont = this.textColor(color);
	...
	Window_Base.prototype.changeSFont = function(n) {
		//NATE PATCH
		this.textColor(n);
		this.contents.sfont = this._sfont;
	};
