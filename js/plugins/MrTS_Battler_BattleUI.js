...
(function() {
	...
	//NATE: change load folder
	ImageManager.loadBattleActor = function(filename, hue) {
		return this.loadBitmap('img/battle_actors/', filename, hue, false);
	};
	...
	Window_BattleActor.prototype.initialize = function(x, y) {
	    ...
	    for (var i = 0; i < $gameParty.battleMembers().length; i++) {
	    	var spr = new Sprite();
	    	spr.bitmap = ImageManager.loadBattleActor("Actor"+$gameParty.battleMembers()[i].actorId());
